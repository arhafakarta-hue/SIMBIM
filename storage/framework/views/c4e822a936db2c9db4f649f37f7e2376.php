...
<head>
    ...
    <title><?php echo e($title ?? 'SIMBIM'); ?></title>
...
<body class="<?php echo e(auth()->check() ? 'is-app' : 'is-auth'); ?>">
        ...
        <div class="app-shell">
            <aside class="sidebar" aria-label="Navigasi utama">
                ...
                <div class="nav-section">
                    <div class="nav-label">Menu <?php echo e(ucfirst($role)); ?></div>
                    <div class="nav-list">
                        <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(in_array($role, $item['roles'])): ?>
                                <a class="nav-link <?php echo e(request()->routeIs($item['route']) ? 'active' : ''); ?>" href="<?php echo e(route($item['route'])); ?>">
            ...
            <div class="main-area">
                <header class="topbar">
                    <div>
                        <div class="topbar-title"><?php echo e($title ?? 'SIMBIM'); ?></div>
                    ...
                    <div class="topbar-actions">
                        ...
                        <div class="user-pill">
                            ...
                            <span>
                                ...
                                <small class="muted"><?php echo e(strtoupper($role)); ?></small>
                            </span>
                        </div>
                    </div>
                </header>
...
<?php /**PATH C:\xampp\htdocs\simbim-realtime-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>